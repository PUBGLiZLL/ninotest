...
void Abp_weekend_revelry_superaward_C::EventShareClicked_NoFetch()
{
	...
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function bp_weekend_revelry_superaward.bp_weekend_revelry_superaward_C.EventShareClicked_NoFetch");
...
void Abp_weekend_revelry_superaward_C::EventShareClicked()
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function bp_weekend_revelry_superaward.bp_weekend_revelry_superaward_C.EventShareClicked");
...
void Abp_weekend_revelry_superaward_C::UserConstructionScript()
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function bp_weekend_revelry_superaward.bp_weekend_revelry_superaward_C.UserConstructionScript");
