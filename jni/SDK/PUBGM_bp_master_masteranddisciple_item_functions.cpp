...
void Abp_master_masteranddisciple_item_C::EventDismissMasterRelationShip_NoFetch()
{
	...
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function bp_master_masteranddisciple_item.bp_master_masteranddisciple_item_C.EventDismissMasterRelationShip_NoFetch");
...
void Abp_master_masteranddisciple_item_C::EventDismissMasterRelationShip()
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function bp_master_masteranddisciple_item.bp_master_masteranddisciple_item_C.EventDismissMasterRelationShip");
...
void Abp_master_masteranddisciple_item_C::UserConstructionScript()
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function bp_master_masteranddisciple_item.bp_master_masteranddisciple_item_C.UserConstructionScript");
