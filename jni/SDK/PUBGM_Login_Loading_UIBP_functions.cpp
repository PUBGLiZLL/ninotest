...
void ULogin_Loading_UIBP_C::InitLoadingTips()
{
	...
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function Login_Loading_UIBP.Login_Loading_UIBP_C.InitLoadingTips");

	ULogin_Loading_UIBP_C_InitLoadingTips_Params params;
...
void ULogin_Loading_UIBP_C::InitLoadingImage()
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function Login_Loading_UIBP.Login_Loading_UIBP_C.InitLoadingImage");

	ULogin_Loading_UIBP_C_InitLoadingImage_Params params;
