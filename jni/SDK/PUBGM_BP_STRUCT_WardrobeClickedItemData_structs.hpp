...
struct FBP_STRUCT_WardrobeClickedItemData
{
	...
	struct FString                                     ins_id_7_11CEFAC244B1967F18C855A628CF582B;                // 0x0010(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	bool                                               is_sourcebook_8_771EC879410F6A334B245EB469974726;         // 0x001C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x001D(0x0003) MISSED OFFSET
	int                                                validHours_9_F60D150A4BE7F2DCD9C8AEB47FA3F9F9;            // 0x0020(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                expireTS_10_01135022493F2554E6892FBE47FCFCAD;             // 0x0024(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                itemSubType_11_CEA9152A43AB7D75B0CA9CA11639EBEF;          // 0x0028(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                itemQuality_12_D2391AA54FB3B7AD7A06A1A78914A778;          // 0x002C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
