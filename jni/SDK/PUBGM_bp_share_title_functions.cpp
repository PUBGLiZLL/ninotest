...
void Abp_share_title_C::EventShowShareResultTitleUI_Push_NoFetch()
{
	...
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function bp_share_title.bp_share_title_C.EventShowShareResultTitleUI_Push_NoFetch");
...
void Abp_share_title_C::EventShowShareResultTitleUI_Push()
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function bp_share_title.bp_share_title_C.EventShowShareResultTitleUI_Push");
...
void Abp_share_title_C::UserConstructionScript()
{
	static UFunction *pFunc = 0;
	if (!pFunc)
		pFunc  = UObject::FindObject<UFunction>("Function bp_share_title.bp_share_title_C.UserConstructionScript");
