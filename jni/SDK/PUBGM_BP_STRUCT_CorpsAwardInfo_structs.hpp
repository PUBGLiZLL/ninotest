...
struct FBP_STRUCT_CorpsAwardInfo
{
	...
	struct FString                                     coprs_name_12_7C340780596DBDA26957126A087DD735;           // 0x0020(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	int                                                last_rank_per_15_6552770067A9CB745EE7A7B305CEFEE2;        // 0x002C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                seg_16_0A426D807EA2FE3A296A6D28071E88C7;                  // 0x0030(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
