...
struct FBP_STRUCT_WardrobeChangedItemData
{
	...
	struct FString                                     ins_id_7_5437CADB4FBE3A56BCAF8E92C3BC3538;                // 0x0010(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	bool                                               is_sourcebook_8_31E036E04BCF30F8B93F838954323F76;         // 0x001C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x001D(0x0003) MISSED OFFSET
	int                                                validHours_9_6061DE364061F81046D4539A8E3A3A97;            // 0x0020(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                expireTS_10_78B7137941914C4B96FCECBAFA3153D9;             // 0x0024(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                itemSubType_11_C232C3204A24D1709AF19BBE71BD84DD;          // 0x0028(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                itemQuality_12_7DCFB9914D0D2E60FE769FAE58D4D7AA;          // 0x002C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
