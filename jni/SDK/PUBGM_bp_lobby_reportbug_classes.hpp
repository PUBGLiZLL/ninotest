...
public:
	...
	int                                                REPROTBUG_REASON_CANNOTENTERBATTLE;                       // 0x02D4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	static UClass* StaticClass()
	{
        ...
        if (!pStaticClass)
            pStaticClass = UObject::FindClass("ScriptBlueprintGeneratedClass bp_lobby_reportbug.bp_lobby_reportbug_C");
		return pStaticClass;
	}
