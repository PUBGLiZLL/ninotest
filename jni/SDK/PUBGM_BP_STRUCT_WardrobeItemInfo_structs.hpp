...
struct FBP_STRUCT_WardrobeItemInfo
{
	...
	struct FString                                     ins_id_10_FB4BC6174B7CBAB4AAEE3D9DE62CBE86;               // 0x000C(0x000C) (Edit, BlueprintVisible, ZeroConstructor)
	bool                                               is_sourcebook_11_099B4E16490E3B2389A0F5B94A0E4B87;        // 0x0018(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0019(0x0003) MISSED OFFSET
	int                                                validHours_12_655C0D7043AFE0DD5939289B7F0CD14C;           // 0x001C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                expireTS_13_1022E6C844F89790B0E5A68F6A4EE323;             // 0x0020(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                itemSubType_14_5B2B9CC14318B7D119A57F9C4E26E093;          // 0x0024(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                itemQuality_15_E9B592464100B4BE66B0AF80EC77B019;          // 0x0028(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
