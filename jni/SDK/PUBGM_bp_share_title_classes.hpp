...
public:
	...
	int                                                BP_ShareTitle_SelectedTitle;                              // 0x02D4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	static UClass* StaticClass()
	{
        ...
        if (!pStaticClass)
            pStaticClass = UObject::FindClass("ScriptBlueprintGeneratedClass bp_share_title.bp_share_title_C");
		return pStaticClass;
	}
